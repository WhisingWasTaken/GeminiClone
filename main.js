...
const suggestionItems = document.querySelectorAll(".sg-item");
...
const GOOGLE_API_KEY = "AIzaSyDOMz-ljURpuSxeXCzkFnSdvCaFAI8tBIE";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message-content">
                <img class="message-avatar" src="Images/profile.png" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message-content">
                <img class="message-avatar" src="Images/gemini.svg" alt="Gemini avatar">
            ...
            <span onClick="copyMessageToClipboard(this)" class="message-icon hide"><i class='bx bx-copy-alt'></i></span>
...
const handleOutgoingMessage = () => {
    currentUserMessage = messageForm.querySelector(".prompt-form-input").value.trim() || currentUserMessage;
...
suggestionItems.forEach(suggestion => {
    suggestion.addEventListener('click', () => {
        currentUserMessage = suggestion.querySelector(".sg-item-text").innerText;
